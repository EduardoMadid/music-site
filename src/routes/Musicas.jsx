import StyledWrapper from "../css/MusicasStyle"
import { CardContainer } from "../css/MusicasStyle"
import { useInView } from 'react-intersection-observer';

const Musicas = () =>{

    const {ref:cards, inView:cardVisible} = useInView();

    return(
        <>
        <CardContainer ref={cards} className={cardVisible ? 'animate-card' : ''}>
            <StyledWrapper>
                <div className="card">
                    <div className="card-img" />
                    <div className="card-info">
                    <p className="text-title">Fone de Ouvido </p>
                    <p className="text-body">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus, consequuntur?</p>
                    </div>
                    <div className="card-footer">
                    <span className="text-title">$189.99</span>
